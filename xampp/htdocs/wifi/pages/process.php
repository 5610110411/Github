...
function addProduct()
{
    $divisionName   = $_POST['txtDivisionName'];
	...
	*/
	...
	$sql   = "INSERT INTO people (DivisionName, FirstName, LastName, Email, Password, DateRegis)
	          VALUES ('$divisionName', '$firstname', '$lastname', '$email', '$password', NOW())";
	/*
