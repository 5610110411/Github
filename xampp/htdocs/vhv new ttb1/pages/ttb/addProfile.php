      ...
      <form class='form-horizontal' role='form' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])."?action=addProfile";?>" method="POST">
        ...
        <div class='form-group'>
          ...
          <div class='col-md-6'>
            <div class='form-group'>
              <div class='col-md-11'>
                <input class='form-control' name='Disease' placeholder='โรค' required>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class='form-group'>
          ...
          <div class='col-md-6'>
            <div class='form-group'>
              <div class='col-md-11'>
                <input class='form-control' name='Equipment' placeholder='เช่น รถเข็น 28355' required>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class='form-group'>
          ...
          <div class='col-md-6'>
            <div class='form-group'>
              <div class='col-md-11'>
                <input class='form-control' name='Picture' placeholder='เช่น https://drive.google.com/open?id=1uX9L4EHV994GXhX' required>
              </div>
            </div>
          </div>
        </div>
