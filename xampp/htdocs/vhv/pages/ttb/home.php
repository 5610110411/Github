<?php
	...
	function createQuery()
	{
		...
		if(empty($IdCard) && empty($FirstName) && empty($LastName) && empty($Tumbon) && empty($Moo)){
			return "SELECT * FROM patient WHERE 1 AND Status LIKE 'valid' AND IdCard LIKE '00000000000000'";
		}else{
			$sql = "SELECT * FROM patient WHERE 1 AND Status LIKE 'valid'";
...
<style>
	...
	*/
	...
	/*added by Nine 21/08/2018 for gray color in select tag*/
    select:invalid{
      color: #bbbbbb;
    }
							...
							<div class="panel-body">
								<form action="home.php" method="post">
									...
									<div class="row">
										<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<select name="Tumbon" class="form-control input-sm">
										...
										<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<select name="Moo" class="form-control input-sm">
														<option value="" disabled selected hidden>หมู่ที่</option>
			...
			<script>
				...
				*/
				...
				for (var count = 0; count < number; count++) {
					...
					if(type[count] == 'A'){
						typeColor = '2';
					}else if(type[count] == 'B'){
						typeColor = '7';
					}else if(type[count] == 'C'){
						typeColor = '5';
					}else{
						typeColor = '1';
					}
					markers[count] = {
						...
						iconImage: 'pictures/'+ typeColor +'.png',
						content: '<h1><a href="profile.php?regName=' + person[count] + '">' + firstname[count] + '</a></h1><p>พิกัด (' + lat[count]+ ', ' + lat[count] + ')</p>'
