<?php
    ...
    <div class='container'>
      <div class='col-xs-8 col-sm-8 col-md-8'>
        <p>พบปัญหาโปรดติดต่อ: คุณมนัสวี จิตมนัส</p>
        <p><!--a href='http://www.kohsamuicity.go.th/frontpage'-->งานสถิติข้อมูลและสารสนเทศ กองวิชาการและแผนงาน เทศบาลนครเกาะสมุย<!--/a--></p>
        <p>โทร: 097-3518111, 077-421421-2 แฟกซ์ ต่อ 153 Email: info@kohsamuicity.go.th</p>
